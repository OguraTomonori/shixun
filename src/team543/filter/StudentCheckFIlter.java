 ...
 */
public class StudentCheckFIlter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if ((userID != null && sessionID != null && permission != null) && permission.equals("2") && UserCheckAction.userCheck(userID, sessionID, permission)) {
			System.out.println("dddasdsagdf");
